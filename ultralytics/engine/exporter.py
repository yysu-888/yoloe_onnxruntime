...
class Exporter:
    ...
    def __call__(self, model=None,max_len=5,embed_dim =512) -> str:
        ...
        tpe = torch.zeros(self.args.batch, max_len, embed_dim).to(self.device)
        self.tpe =tpe
